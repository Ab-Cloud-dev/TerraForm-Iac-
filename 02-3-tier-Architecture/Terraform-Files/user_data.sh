...
sudo mysql -h webapp-instance.cwf4iae6idmi.us-east-1.rds.amazonaws.com -u admin -pMaluna51403739

#(Replace with your database endpoints, username and password)
